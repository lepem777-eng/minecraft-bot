...
console.log(`Minecraft client installed: ${fs.existsSync(path.join(client, 'version.json')) && fs.existsSync(path.join(client, `${config.minecraft.version}.jar`)) && fs.existsSync(path.join(client, 'libraries')) && fs.existsSync(path.join(client, 'assets', 'objects'))}`);
...
console.log(`Viewer port: ${config.viewer.publicPort}`);
